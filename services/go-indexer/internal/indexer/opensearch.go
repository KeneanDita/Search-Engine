	...
	mapping := map[string]interface{}{
		...
		"mappings": map[string]interface{}{
			"properties": map[string]interface{}{
				...
				"title":          map[string]interface{}{"type": "text", "analyzer": "custom_analyzer"},
				"content":        map[string]interface{}{"type": "text", "analyzer": "custom_analyzer"},
				"tokens":         map[string]interface{}{"type": "keyword"},
				"keyphrases":     map[string]interface{}{"type": "keyword"},
				"entities":       map[string]interface{}{"type": "object", "enabled": false},
				"embedding":      map[string]interface{}{"type": "knn_vector", "dimension": 384},
				...
				"published_date": map[string]interface{}{"type": "date", "ignore_malformed": true},
				"crawled_at":     map[string]interface{}{"type": "date", "format": "epoch_second"},
